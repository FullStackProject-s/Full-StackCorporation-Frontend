...
export const EyePasswordOpen: React.FC = () => {
  return (
    <div>
        <svg
          version="1.1"
        ...
        <g>
          <g>
            <path
              d="M513.095,245.101c0,0-140.683-139.842-253.291-139.842c-112.608,0-253.292,139.842-253.292,139.842
        ...
        s50.184-112.149,112.149-112.149c61.965,0,112.148,50.26,112.148,112.149S322.763,372.397,260.875,372.397z"
            />
            <path
              d="M259.574,187.726c-39.321,0-71.222,32.053-71.222,71.451c0,39.397,31.901,71.451,71.222,71.451
